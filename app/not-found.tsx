    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
        <div className="flex flex-col items-center max-w-sm mx-auto text-center">
          ...
          <div className="p-3 text-blue-500 rounded-full bg-blue-50 dark:bg-gray-800">
          ...
          <div className="flex items-center w-full mt-6 gap-x-3 sm:w-auto">
            ...
            <button
              type="button"
              className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg sm:w-auto
              hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 gap-x-2"
            >
